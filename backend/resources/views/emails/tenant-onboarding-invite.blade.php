...
<head>
    ...
    <title>Your Agency Portal is Ready</title>
    <style>
...
<body>
    <h1>Your Agency Portal is Ready</h1>
    <p>Hi,</p>
    <p>{{ $companyName }} has been set up on our platform. Use the details below to sign in to your admin panel.</p>
